...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221010_test_131fa56c532ee7093484_20221010111008_archive.zip';
        const ARCHIVE_SIZE       = '14613357';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '131fa56-10111008';
        const SECONDARY_PACKAGE_HASH = 'f796c8e-10111008';
        const VERSION            = '1.5.0';
